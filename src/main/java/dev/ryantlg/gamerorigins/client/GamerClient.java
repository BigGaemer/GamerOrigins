package dev.ryantlg.gamerorigins.client;

import static dev.ryantlg.gamerorigins.core.registry.ModItems.*;
...
import dev.ryantlg.gamerorigins.core.util.CameraSystem;
import dev.ryantlg.gamerorigins.core.util.ColourHelper;
...
public class GamerClient implements ClientModInitializer {
	public static final EntityModelLayer FEATHERED = new EntityModelLayer(new Identifier(Gamer.MOD_ID, "feathered"), "main");
	public static final EntityModelLayer LEATHER = new EntityModelLayer(new Identifier(Gamer.MOD_ID, "leather"), "main");
	public static final EntityModelLayer LIGHT = new EntityModelLayer(new Identifier(Gamer.MOD_ID, "light"), "main");
	public static final EntityModelLayer FLANDRE = new EntityModelLayer(new Identifier(Gamer.MOD_ID, "flandre"), "main");
	public static final EntityModelLayer DISCORD = new EntityModelLayer(new Identifier(Gamer.MOD_ID, "discord"), "main");
	public static final EntityModelLayer ZANZA = new EntityModelLayer(new Identifier(Gamer.MOD_ID, "zanza"), "main");
